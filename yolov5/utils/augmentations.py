...
class Albumentations2:
    # YOLOv5 Albumentations2 class (optional, only used if package is installed)
    def __init__(self):
        self.transform = None
        try:
            import albumentations as A
...
def augment_hsv(im, hgain=0.5, sgain=0.5, vgain=0.5):
    ...
    #b_hsv, g_hsv, r_hsv = cv2.split(im)

    #im=cv2.merge([b_hsv, g_hsv, r_hsv , i])
